...
namespace TechChallenge.Infrastracture.Data
{
    public sealed class FiapDbContext : DbContext, IUnitOfWork
    {
        private readonly IMediatorHandler _mediatorHandler;

        public FiapDbContext(DbContextOptions<FiapDbContext> options, IMediatorHandler mediatorHandler)
          : base(options)
        {
