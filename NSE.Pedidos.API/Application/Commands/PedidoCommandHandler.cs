...
using Fiap.Pedidos.API.Application.Events;
...
using Fiap.Pedidos.Domain.Pedidos.ValueObjects;
using Fiap.Pedidos.Domain.Vouchers.Validations;

namespace Fiap.Pedidos.API.Application.Commands
{
